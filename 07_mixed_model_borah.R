...
priors <- c(
  ...
  set_prior('normal(0,5)', class = 'b', coef = 'scale_ubrb_prcp'),
  set_prior('normal(0,5)', class = 'b', coef = 'scale_pivot_prop'),
  set_prior('normal(0,5)', class = 'b', coef = 'scale_decreed_year')
)
# 
...
rf_arma_full <- brm(lt ~ (1 | Name) + scale_decreed_year + scale_pivot_prop + scale_ubrb_prcp + scale_class1_urban + scale_et + scale_wy_prcp + scale_irrig_temp + scale_DivFlow + arma( gr = Name),
                    data = rf,
                    iter = 4000,
                    family = 'normal',
                    prior = priors,
