...
arma_ng <- readRDS('/Users/dbeisel/Desktop/DATA/Bridget/Drains_Lower_Boise_River/model_output/arma_nogroup_mod3.Rdata')
...
ggarrange(et, temp, precip, ubrb_prcp, Carryover, canal, pivot, urban, ncol=2, nrow = 4, labels = c('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'))
